...
public class Packet {
    ...
    // public ICMPHeader icmpHeader;
    public ByteBuffer backingBuffer;

    private boolean isTCP;
    private boolean isUDP;
    private boolean isTCMP;
    ...
    public Packet(ByteBuffer buffer) throws UnknownHostException {
        ...
        if (this.ip4Header.protocol == IP4Header.TransportProtocol.TCP) {
            ...
            this.isUDP = true;
        }/*else if(this.ip4Header.protocol ==IP4Header.TransportProtocol.ICMP){
            this.icmpHeader = new ICMPHeader(buffer);
        }*/
  ...
  /*  public static class ICMPHeader {
        ...
        public char icmph_type;
        public char icmph_code;
        public int icmph_chksum;
        public int icmph_ident;
        public int icmph_seqnum;

        public ICMPHeader(ByteBuffer buffer) {
            this.icmph_type = BitUtils.getUnsignedShort(buffer.getShort())
            this.icmph_code = icmph_code;
            this.icmph_chksum = icmph_chksum;
            this.icmph_ident = icmph_ident;
            this.icmph_seqnum = icmph_seqnum;
        }
    }*/
